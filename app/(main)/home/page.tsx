...
export default async function HomePage() {
  let showingMovies: Movie[] = [];
  let comingMovies: Movie[] = [];
  ...
  try {
    ...
    showingMovies = showingRes.movies;
    comingMovies = comingRes.movies;
  } catch (error) {
    ...
    <main className="container mx-auto px-4 py-8">
      ...
      {showingMovies.length > 0 ? (
        <section className="mb-12 relative">
          ...
          />
          <div className="absolute inset-0 bg-black/50 rounded-3xl flex flex-col justify-end p-8">
